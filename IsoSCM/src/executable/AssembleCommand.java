...
@XmlRootElement(name="AssembleCommand")
...
public class AssembleCommand{	
	...
	File dir = new File("isoscm").getAbsoluteFile();
	...
	public Double getInsert_size_quantile() {
		return insert_size_quantile;
	}
	...
	@XmlElement
	public void setInsert_size_quantile(Double insert_size_quantile) {
		this.insert_size_quantile = insert_size_quantile;
	}
